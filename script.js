    ...
    try {
      ...
      if (data.status === "done" && data.videoUrl) {
        ...
        if (playerEl) {
          ...
          playerEl.onerror = () => {
            if (statusEl) statusEl.innerHTML = `<i class="fas fa-circle-check"></i> Video ready! · <a href="${absUrl}" target="_blank" style="color:#22d3ee;text-decoration:underline;font-weight:700;">Open Video ↗</a>`;
        ...
        if (statusEl) statusEl.innerHTML = `<i class="fas fa-circle-check"></i> Video generated successfully. · Preview below`;
        if (playerEl) {
